...
from src.model import Beam


class NeuralModeller:
    ...
    def process(self, imgs):
        ...
        self.translate_batch(src_seq=src_seq, src_pos=src_pos)
    ...
    def __call__(self, left_img, top_img, front_img):
        return self.process(left_img, top_img, front_img)
