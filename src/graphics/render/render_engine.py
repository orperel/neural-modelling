...
class RenderEngine:
    ...
    def setup_splitscreen(self, invoke_perspective_rotation=False):
        ...
        left_camera_node.setPos(10, 0, 0)
        ...
        front_camera_node.setPos(0, 10, 0)
        ...
        perspective_camera_node.setPos(10, 10, 10)
        ...
        def spinCameraTask(task):
            ...
            perspective_camera_node.setPos(10 * sin(angleRadians), -10.0 * cos(angleRadians),
                                           10 * sin(angleRadians))
            perspective_camera_node.lookAt((0, 0, 0))
            return Task.cont
